using System.Text;
using FinLedger.Ledger.Api.Middleware;
using FinLedger.Ledger.Api.Options;
using FinLedger.Ledger.Application.Constants;
using FinLedger.Ledger.Application.UseCases;
using FinLedger.Ledger.Infrastructure;
...
{
    foreach (var permission in LedgerPermissions.All)
    {
